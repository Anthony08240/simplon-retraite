...
Prix: 1050€ (wifi inclue)</div>
    ...
    <div class="residence1">
        <div class="txtres"><p class="photo"><img class="appart1" src="img/appart 3.jpg"></div>
        <div class="appart2">Concernant la résidence :<br>
...
Prix: 550€</div>
        <div class="photos"><img class="appart1" src="img/appart 4.jpg"></div>
    </div>
    <div class="footer">
